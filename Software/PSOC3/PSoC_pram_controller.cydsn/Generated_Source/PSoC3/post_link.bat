...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\J.C.Joachim\Desktop\Gruppe 8\Implementering\Software\PSoC\PSoC_pram_controller.cydsn\PSoC_pram_controller.svd" rem "C:\Users\J.C.Joachim\Desktop\Gruppe 8\Implementering\Software\PSoC\PSoC_pram_controller.cydsn\PSoC_pram_controller.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
