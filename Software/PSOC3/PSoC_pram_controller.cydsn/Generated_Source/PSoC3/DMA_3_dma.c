...
uint8 DMA_3_DmaInitialize(uint8 BurstCount, uint8 ReqestPerBurst, uint16 UpperSrcAddress, uint16 UpperDestAddress) 
{
    ...
    DMA_3_DmaHandle = DMA_3__DRQ_NUMBER;

    if(DMA_3_DmaHandle != DMA_INVALID_CHANNEL)
    {
        /* Configure the channel. */
        CyDmaChSetConfiguration(DMA_3_DmaHandle,
                                BurstCount,
                                ReqestPerBurst,
                                DMA_3__TERMOUT0_SEL,
                                DMA_3__TERMOUT1_SEL,
        ...
        CyDmaChSetExtendedAddress(DMA_3_DmaHandle, UpperSrcAddress, UpperDestAddress);

        /* Set the priority for this channel */
        CyDmaChPriority(DMA_3_DmaHandle, DMA_3__PRIORITY);
    }
...
void DMA_3_DmaRelease(void) 
{
    ...
    CyDmaChDisable(DMA_3_DmaHandle);
