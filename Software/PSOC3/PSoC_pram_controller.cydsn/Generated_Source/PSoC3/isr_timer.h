...
#define isr_timer_INTC_VECTOR            ((reg16 *) isr_timer__INTC_VECT)
...
#define isr_timer_INTC_SET_EN            ((reg8 *) isr_timer__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the isr_timer interrupt. */
#define isr_timer_INTC_CLR_EN            ((reg8 *) isr_timer__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the isr_timer interrupt state to pending. */
#define isr_timer_INTC_SET_PD            ((reg8 *) isr_timer__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the isr_timer interrupt. */
#define isr_timer_INTC_CLR_PD            ((reg8 *) isr_timer__INTC_CLR_PD_REG)
