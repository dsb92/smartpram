...
{
    if (Mixer_1_aclk_CLKEN & Mixer_1_aclk_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Mixer_1_aclk_SetModeRegister(uint8 clkMode) 
{
    Mixer_1_aclk_MOD_SRC |= clkMode & Mixer_1_aclk_MODE_MASK;
}
...
*
*******************************************************************************/
void Mixer_1_aclk_ClearModeRegister(uint8 clkMode) 
{
    Mixer_1_aclk_MOD_SRC &= ~clkMode | ~Mixer_1_aclk_MODE_MASK;
}
...
{
    return Mixer_1_aclk_MOD_SRC & Mixer_1_aclk_MODE_MASK;
}
...
void Mixer_1_aclk_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Mixer_1_aclk_MOD_SRC =
            (Mixer_1_aclk_MOD_SRC & ~Mixer_1_aclk_SRC_SEL_MSK) | clkSource;
    }
