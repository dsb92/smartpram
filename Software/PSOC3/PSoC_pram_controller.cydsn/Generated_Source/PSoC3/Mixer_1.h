...
/* They are defined starting with cy_boot v3.0 */
    ...
    #error Component Mixer_v1_91 requires cy_boot v3.0 or later
#endif /* (CY_ PSOC5LP) */
...
typedef struct _Mixer_1_backupStruct
{
    uint8   enableState;
}   Mixer_1_BACKUP_STRUCT;

#if (CY_PSOC5A)
    /* Stop API changes for PSoC5A */
    typedef struct _Mixer_1_lowPowerBackupStruct
    {
        uint8 CR1_REG;
        uint8 CR2_REG;
    }   Mixer_1_LOWPOWER_BACKUP_STRUCT;
#endif /* CY_PSOC5A */
...
#define Mixer_1_ENABLED                (0x01u)
#define Mixer_1_DISABLED               (0x00u)
...
#define Mixer_1_LO_CLOCK_FREQ_100_KHz  (100)
...
#define Mixer_1_VDDA_THRESHOLD_MV      (3500u)
...
#define Mixer_1_EXTERNAL_LO_CLK_FREQ   (-1)
#define Mixer_1_VddaVal                (5)

#if (Mixer_1_LO_SOURCE == Mixer_1_LO_SOURCE_INTERNAL)
    /* Internal LO clock frequency */
    #define Mixer_1_LO_CLOCK_FREQ      (100)
#else
    #define Mixer_1_LO_CLOCK_FREQ      ((-1 == Mixer_1_UNKNOWN_EXTERNAL_LO) ? (100) : (-1))
...
#define Mixer_1_MODE_CTMIXER           (0x02u << 1)
#define Mixer_1_MODE_DTMIXER           (0x03u << 1)
...
#define Mixer_1_COMP_MASK              (0x03u << 2)
#define Mixer_1_COMP_3P0PF             (0x00u << 2)
#define Mixer_1_COMP_3P6PF             (0x01u << 2)
#define Mixer_1_COMP_4P35PF            (0x02u << 2)
#define Mixer_1_COMP_5P1PF             (0x03u << 2)

/* Bit Field  SC_DIV2_ENUM - SCxx_CR1[4] */
#define Mixer_1_DIV2                   (0x01u << 4)
#define Mixer_1_DIV2_DISABLE           (0x00u << 4)
#define Mixer_1_DIV2_ENABLE            (0x01u << 4)

/* Bit Field  SC_GAIN_ENUM - SCxx_CR1[5] */
#define Mixer_1_GAIN                   (0x01u << 5)
#define Mixer_1_GAIN_0DB               (0x00u << 5)
#define Mixer_1_GAIN_6DB               (0x01u << 5)
...
#define Mixer_1_R20_40B                (0x01u << 1)
#define Mixer_1_R20_40B_40K            (0x00u << 1)
#define Mixer_1_R20_40B_20K            (0x01u << 1)

/* Bit Field  SC_REDC_ENUM  - SCxx_CR2[3:2] */
#define Mixer_1_REDC_MASK              (0x03u << 2)
#define Mixer_1_REDC_00                (0x00u << 2)
#define Mixer_1_REDC_01                (0x01u << 2)
#define Mixer_1_REDC_10                (0x02u << 2)
#define Mixer_1_REDC_11                (0x03u << 2)

/* Bit Field  SC_RVAL_ENUM  - SCxx_CR2[6:4] */
#define Mixer_1_RVAL_MASK              (0x07u << 4)
#define Mixer_1_RVAL_20K               (0x00u << 4)
#define Mixer_1_RVAL_30K               (0x01u << 4)
#define Mixer_1_RVAL_40K               (0x02u << 4)
#define Mixer_1_RVAL_80K               (0x03u << 4)
#define Mixer_1_RVAL_120K              (0x04u << 4)
#define Mixer_1_RVAL_250K              (0x05u << 4)
#define Mixer_1_RVAL_500K              (0x06u << 4)
#define Mixer_1_RVAL_1000K             (0x07u << 4)

/* Bit Field  SC_PGA_GNDVREF_ENUM - SCxx_CR2[7] */
#define Mixer_1_GNDVREF                (0x01u << 7)
#define Mixer_1_GNDVREF_DI             (0x00u << 7)
#define Mixer_1_GNDVREF_E              (0x01u << 7) 

/* SC Block Clock Control SCx.CLk */
#define Mixer_1_DYN_CNTL_EN            (0x01u << 5)
#define Mixer_1_BYPASS_SYNC            (0x01u << 4)
#define Mixer_1_CLK_EN                 (0x01u << 3)

/* SC Block Boost Clock Selection Register - Boost Clock Enable  SCxx_BST[3]  */
#define Mixer_1_BST_CLK_EN             (0x01u << 3)
