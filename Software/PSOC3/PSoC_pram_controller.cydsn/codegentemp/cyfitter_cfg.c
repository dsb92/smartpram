...
#define BS_UDB_0_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x00080380u)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x00080400u)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x00080408u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x00080410u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x00080418u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x00080420u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x00080428u)

/* PHUB_CFGMEM8 Address: CYREG_PHUB_CFGMEM8_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM8_VAL ((const uint8 CYFAR *)0x0008042Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_PRT0_AG, 0x83u);
	CY_SET_REG8((void CYXDATA *)CYREG_PRT3_AG, 0x80u);
	CY_SET_REG8((void CYXDATA *)CYREG_BG_CR0, 0x09u);
	CY_SET_REG8((void CYXDATA *)CYREG_SC2_SW0, 0x20u);
	CY_SET_REG8((void CYXDATA *)CYREG_SC2_SW4, 0x80u);
	CY_SET_REG8((void CYXDATA *)CYREG_DAC2_SW0, 0x10u);
	CY_SET_REG8((void CYXDATA *)CYREG_CMP1_SW3, 0x40u);
	CY_SET_REG8((void CYXDATA *)CYREG_CMP1_SW4, 0x10u);
	CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW4, 0x80u);
	CY_SET_REG8((void CYXDATA *)CYREG_OPAMP3_MX, 0x21u);
	CY_SET_REG8((void CYXDATA *)CYREG_BUS_SW0, 0x80u);
...
uint8 CYXDATA * const CYCODE AMux_1__addrTable[4] = {
	...
	(uint8 CYXDATA *)CYREG_SC2_SW8, (uint8 CYXDATA *)CYREG_DSM0_SW0, 
};
